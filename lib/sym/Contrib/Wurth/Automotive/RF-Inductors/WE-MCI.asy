...
SYMATTR Description WE-MCI Multilayer Ceramic SMT Inductor \nAfter inserting, right-click on the symbol to select the part number. \nwww.we-online.com/catalog/WE-MCI \n\nPlease note disclaimer in lib/sub/Contrib/Wurth/WE-MCI.lib.
SYMATTR SpiceModel 0402_7847803100_1n
SYMATTR Prefix x
SYMATTR InstName L
SYMATTR ModelFile Contrib/Wurth/WE-MCI.lib
PIN -48 0 NONE 8
PINATTR PinName 1
