...
SYMATTR Description WE-CMBH Common Mode Power Line Choke (Horizontal)\nAfter inserting, right-click on the symbol to select the part number. \nwww.we-online.com/catalog/WE-CMBH \n\nPlease note disclaimer in lib/sub/Contrib/Wurth/WE-CMBH.lib.
