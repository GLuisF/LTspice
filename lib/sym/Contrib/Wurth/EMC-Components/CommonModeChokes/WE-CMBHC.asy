...
SYMATTR Description WE-CMB HC Common Mode Power Line Choke \nAfter inserting, right-click on the symbol to select the part number. \nwww.we-online.com/catalog/WE-CMB-HC \n\nPlease note disclaimer in lib/sub/Contrib/Wurth/WE-CMBHC.lib.
