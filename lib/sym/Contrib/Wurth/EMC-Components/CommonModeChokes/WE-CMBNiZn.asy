...
SYMATTR Description WE-CMB NiZn Common Mode Power Line Choke\nAfter inserting, right-click on the symbol to select the part number. \nwww.we-online.com/catalog/WE-CMB-NIZN \n\nPlease note disclaimer in lib/sub/Contrib/Wurth/WE-CMBNiZn.lib.
