...
SYMATTR Description WE-CNSW HF SMT Common Mode Line Filter \nAfter inserting, right-click on the symbol to select the part number. \nwww.we-online.com/catalog/WE-CNSW-HF \n\nPlease note disclaimer in lib/sub/Contrib/Wurth/WE-CNSW_HF.lib.
