...
SYMATTR Value AD3530R
SYMATTR SpiceLine Gain=2
SYMATTR Prefix X
SYMATTR Value2 AD3530R
SYMATTR Description 8-Channel, 16-Bit Voltage Output DACs, On-Chip Reference, SPI (one channel, output stage modeled)
SYMATTR ModelFile AD3530R.sub
PIN -160 0 LEFT 8
