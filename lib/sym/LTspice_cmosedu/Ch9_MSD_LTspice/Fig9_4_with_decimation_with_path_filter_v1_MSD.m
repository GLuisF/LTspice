...
%components, WITH decimation followed by a path filter and the clock 
%signals seen in that figure (no added delay in the forward paths). 

clear all; close all;

rawfilename = '_Fig9_4_with_decimation_with_path_filter_v1_MSD.raw';
