...
%components, WITH decimation followed by a path filter. Ts/2 added 
%forward delay (worst case using ideal components).

clear all; close all;

rawfilename = '_Fig9_4_with_decimation_with_path_filter_v3_MSD.raw';
