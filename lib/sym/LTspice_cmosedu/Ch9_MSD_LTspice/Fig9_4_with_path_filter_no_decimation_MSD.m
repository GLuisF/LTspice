...
%components, WITH path filter, and the clock signals seen in that figure 
%(no added delay in the forward paths). 

clear all; close all;

rawfilename = '_Fig9_4_with_path_filter_no_decimation_MSD.raw';
