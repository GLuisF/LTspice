...
SYMATTR Prefix X
SYMATTR Description A two pole op amp with delay, programmable phase margin, slew rate limit, and output voltage and current limit. See Educational/UniversalOpAmp.asc for more details.
...
SYMATTR ModelFile UniversalOpAmp3b.lib
PIN -32 16 NONE 0
PINATTR PinName In+
