...
SYMATTR Prefix X
SYMATTR Description A two pole op amp with virtual ground, input and output impedance, programmable phase margin, slew rate limit, and output voltage and current limit. See Educational/UniversalOpAmp.asc for more details.
