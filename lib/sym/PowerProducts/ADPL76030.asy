Version 4
SymbolType BLOCK
RECTANGLE Normal 304 464 -304 -544
TEXT 0 0 Center 2 LT
WINDOW 3 0 240 Center 2
WINDOW 0 0 -240 Center 2
SYMATTR Value ADPL76030
SYMATTR Prefix X
SYMATTR SpiceModel ADPL76030.sub
SYMATTR Value2 ADPL76030
SYMATTR Description 55V 1.4MHz Synchronous 4-Switch Buck-Boost Controller with Spread Spectrum
PIN -304 -368 LEFT 8
PINATTR PinName BG1
