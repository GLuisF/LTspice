...
SYMATTR Prefix X
SYMATTR Description 20A, 16V Single Phase Dual Output Step-Down Silent Switcher with Digital Power System Management \n\nNote: SDA, SCL, _Alert, Share_clk, WP, GPIOs, ASEL, TSNSs are not modeled
...
SYMATTR SpiceLine2 GMEA_CONTROL=10  RITH=7k CITH=320p MFR_PWM_PHASE=180 OUTPUT_DISCHARGE=1 VOUT_UV_FAULT_LIMIT=4.8 VOUT_OV_FAULT_LIMIT=5.2 VOUT_UV_WARN_LIMIT=4.9 VOUT_OV_WARN_LIMIT=5.1 MFR_DISCHARGE_THRESHOLD=0.2
PIN -208 -288 LEFT 8
