...
SYMATTR Value LTC3311-0.875
SYMATTR Prefix X
SYMATTR SpiceModel LTC3311-0.875.sub
SYMATTR Value2 LTC3311-0.875
SYMATTR Description 5V, 12.5A Monolithic Synchronous Step-down Regulator, Fixed 0.875V Output \n\nNote: SSTT pin Temperature Monitoring function is not modeled
PIN 0 -176 TOP 8
PINATTR PinName Vin
